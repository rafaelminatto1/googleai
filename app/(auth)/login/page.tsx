  ...
  const onSubmit: SubmitHandler<LoginFormValues> = async (data) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // Redireciona para a URL de callback ou dashboard
      ...
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <div className="bg-red-50 text-red-700 border border-red-200 rounded-lg text-sm p-3 flex items-center">
         ...
         <div className="text-center text-xs text-slate-500 mt-4 space-y-1">
            ...
            <p>(Ou crie novos usuários no banco de dados)</p>
         </div>
      </div>
    </div>
  );
